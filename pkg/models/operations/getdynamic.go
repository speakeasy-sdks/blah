...
func (o *GetDynamicResponse) GetGlobalTestException() *sdkerrors.GlobalTestException {
	if o == nil {
		return nil
	}
...
func (o *GetDynamicResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *GetDynamicResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
